...
string normalize2(string sInput);
...
int main(int argc, const char * argv[])
{
   ...
   cout << "Welcome to the Writing-Style Tester!" << endl;
   cout << "Using a Bayesian Inference Model, you can find out which author" <<
   " mirrors your writing style the most!" << endl;
   cout << "Currently, the authors in the database are: "
   << "Charles Dickens and Jane Austen" << endl;
   ...
   while(true)
   {
      ...
      {
         cout << "Your writing most closely matches the style of Austen!"
         << endl;
      }
      else if(austenProb == dickensProb)
      {
         cout << "Your writing most closely matches the style of Austen!"
         << endl;
      }
      ...
      {
         cout << "Your writing most closely matches the style of Dickens!"
         << endl;
      }
   }
   return 0;
